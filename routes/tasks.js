...
const {addTask,getTask,getTaskByTag,update,deleteTask,getTagName}=require("../controllers/tasks");
//params
...
//get task by tag
router.get("/task/getTaskByTags/:userId/:tag",isSignedIn,isAuthorized,getTaskByTag);
//update task
